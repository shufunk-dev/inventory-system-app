...
## 1. Security & Offline Recovery
- **Cryptographic Remote Support Tokens (Asymmetric Support Access)**:
  - Technical support is enabled offline without hardcoded backdoors. If support is requested, the owner imports a time-limited token signed with your private key, granting temporary admin access that expires automatically after 24 hours.

## 2. Remote Cloud Aggregation & Sync Options
...
## 3. Countertop Tablet POS Register Layout
